...
- **THEN** the script taps `achannarasappa/tap`, grants it trust, runs `brew install achannarasappa/tap/ticker`, and the `ticker` binary becomes available in PATH
