...
This skill activates when changes are made (or planned) to dotfiles configuration files. It determines whether the interactive manual/cheatsheet needs updating and proposes specific HTML changes.
