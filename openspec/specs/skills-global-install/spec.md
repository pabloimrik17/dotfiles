# Capability: skills-global-install

## Purpose

Global agent skills installation managed by chezmoi — individual skill packages installed via the skills.sh CLI during machine setup.
