# Capability: zsh-completions

## Purpose

Installation and FPATH integration of the zsh-completions package across macOS (Homebrew, arm64/x86) and Linux, loaded before Oh-My-Zsh's compinit.
