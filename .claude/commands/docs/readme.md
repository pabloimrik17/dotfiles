...
Apply only the approved text changes. Before writing, read
`.agents/skills/update-readme/references/readme-conventions.md` for the exact table-row, badge,
and screenshot-block patterns. Screenshot descriptions stay instructions — the user captures
the images.
