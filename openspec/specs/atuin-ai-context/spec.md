# Capability: atuin-ai-context

## Purpose

User-scoped context file for `atuin ai` managed by chezmoi -- documents the local stack, owned tool keybindings, and common workflows so AI command suggestions match the user's actual environment without leaking secrets.
