...
- [x] 1.1 Add `mcpServers` key to `dot_claude/settings.json.tmpl` with the 7 servers (eslint, context7, knip, memory, playwright, chrome-devtools, gh_grep) using `@latest` versions
