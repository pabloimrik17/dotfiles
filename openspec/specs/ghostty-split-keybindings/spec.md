# Capability: ghostty-split-keybindings

## Purpose

Configure Ghostty keybindings for creating, navigating, resizing, and managing terminal splits — providing a full split workflow via keyboard shortcuts.
